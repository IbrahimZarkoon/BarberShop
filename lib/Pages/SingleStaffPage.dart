              ...
              child: Column(
                ...
                children: [
                  ...
                  GridView.builder(
                      ...
                      scrollDirection: Axis.vertical,
                      physics: BouncingScrollPhysics(),
                      padding: EdgeInsets.only(left: 5,right: 5,bottom: MediaQuery.sizeOf(context).height*0.025),
        ...
        children: [
          ...
          EasyDateTimeLine(
            ...
            timeLineProps: EasyTimeLineProps(
              hPadding: MediaQuery.sizeOf(context).height*0.025
            ),
            ...
            headerProps:  EasyHeaderProps(
              padding: EdgeInsets.only(top: MediaQuery.sizeOf(context).height*0.005,bottom: MediaQuery.sizeOf(context).height*0.005),
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              padding:EdgeInsets.all(index == selectedServiceIndex?MediaQuery.sizeOf(context).height * 0.015 : 0) ,
              child: Image.asset(
                image,
                color:index == selectedServiceIndex? primaryColor :  black,
                fit: index == selectedServiceIndex? BoxFit.contain : BoxFit.scaleDown,
              ),
            ),
            const SizedBox(
              height: 5,
...
class _TimeSlotsGridState extends State<TimeSlotsGrid> {
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      scrollDirection: Axis.vertical,
      physics: BouncingScrollPhysics(),
      padding: EdgeInsets.only(bottom: MediaQuery.sizeOf(context).height*0.03,left: MediaQuery.sizeOf(context).height*0.025,right: MediaQuery.sizeOf(context).height*0.025),
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
        crossAxisCount: 3,
        crossAxisSpacing: MediaQuery.of(context).size.height * 0.025,
        mainAxisSpacing: MediaQuery.of(context).size.height * 0.025,
        childAspectRatio: 1,
        mainAxisExtent: MediaQuery.sizeOf(context).height*0.05,
      ),
